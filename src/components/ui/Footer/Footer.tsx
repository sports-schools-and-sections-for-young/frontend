...
const Footer: FC = () => {
  return (
    <footer className={styles.darkPart}>
      <div className={styles.footerContainer}>
        <div className={styles.textWrapper}>
          <p>
            Используя сервис, вы даете согласие на обработку персональных данных
            и соглашаетесь с Пользовательским соглашением и Политикой
