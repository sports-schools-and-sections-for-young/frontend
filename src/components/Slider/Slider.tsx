...
import { ButtonColor, ButtonHeight, ButtonFeature, IconSide } from '../ui/Button/types';
      ...
      <div className={styles.containerSlider}>
        ...
        <div className={styles.containerButton}>
          ...
          <span className={styles.numberSlider}>
            <span className={styles.leadingNumbers}>{formatNumber(currentSlide + 1)}</span>/{formatNumber(sportsData.length)}
          </span>
        </div>
      </div>
    </div>
