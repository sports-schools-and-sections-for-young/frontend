try {
      ...
      if ((t && typeof t == "object") || typeof t == "function")
        for (let a of l2(t))
          !d2.call(e, a) &&
            ...
            Aa(e, a, {
              get: () => t[a],
              enumerable: !(n = s2(t, a)) || n.enumerable,
            });
      return e;
    };
  var fe = (e, t, r) => (
  ...
  var Xs = F((pM, Ys) => {
    ...
    jt.prototype.clear = DE;
    jt.prototype.delete = CE;
    jt.prototype.get = xE;
    jt.prototype.has = SE;
    jt.prototype.set = FE;
    Ys.exports = jt;
  ...
  var un = F((zM, dl) => {
    ...
    Mt.prototype.clear = $E;
    Mt.prototype.delete = HE;
    Mt.prototype.get = UE;
    Mt.prototype.has = zE;
    Mt.prototype.set = GE;
    dl.exports = Mt;
  ...
  var sn = F((QM, hl) => {
    ...
    qt.prototype.clear = QE;
    qt.prototype.delete = ZE;
    qt.prototype.get = eA;
    qt.prototype.has = tA;
    qt.prototype.set = rA;
    hl.exports = qt;
    ...
    function gA(e, t, r, n, a, o) {
      ...
      for (o.set(e, t), o.set(t, e); ++E < u; ) {
        ...
        if (g) {
          if (
            !pA(t, function (S, B) {
              if (!fA(g, B) && (A === S || a(A, S, r, n, o))) return g.push(B);
            })
          ) {
            m = !1;
            break;
  ...
  var Uc = F((iU, Hc) => {
    ...
    function nC(e, t, r, n, a, o) {
      ...
      if (m && !y)
        return (
          o || (o = new Bo()),
          i || eC(e) ? JD(e, t, r, n, a, o) : QD(e, t, s, r, n, a, o)
        );
      if (!(r & tC)) {
  ...
  var md = F((ez, hd) => {
    ...
    function fd(e) {
      ...
      if (jC(e)) return LC(e, fd) + "";
      if (MC(e)) return pd ? pd.call(e) : "";
      var t = e + "";
  ...
  var xn = F((hG, $d) => {
    ...
    function Gx(e, t, r) {
      var n = e[t];
      (!(zx.call(e, t) && Hx(n, r)) || (r === void 0 && !(t in e))) &&
        $x(e, t, r);
    }
    $d.exports = Gx;
  });
  ...
  var Tn = F((_p, Jo) => {
    ...
    (function (e) {
      ...
      return (function n(a, o, i) {
        ...
        for (var s = typeof pr == "function" && pr, p = 0; p < i.length; p++)
          u(i[p]);
        return u;
      })(
        {
  ...
  var e0 = F((PK, Zf) => {
    ...
    function On(e, t, r, n, a, o) {
      ...
      if (y) {
        ...
        var E = W5(e),
          m = E == Jf || E == c3;
        if (J5(e)) return q5(e, u);
        if (E == Qf || E == Xf || (m && !a)) {
          if (((i = s || m ? {} : Y5(e)), !u))
            return s ? U5(e, M5(i, e)) : H5(e, j5(i, e));
        } else {
          if (!le[E]) return a ? e : {};
          i = K5(e, E, u);
        }
      ...
      return (
        N5(b || e, function (x, S) {
          b && ((S = x), (x = e[S])), L5(i, S, On(x, t, r, S, e, o));
        }),
        i
      );
    }
  ...
  var R0 = F((iX, O0) => {
    ...
    function RB(e, t, r) {
      return (
        ...
        function () {
          for (
            var n = arguments, a = -1, o = _0(n.length - t, 0), i = Array(o);
            ++a < o;
  ...
  var Mn = F((IX, J0) => {
    ...
    J0.exports = { SynchronousPromise: ae };
  });
  var ri = F((nJ, Z0) => {
    l();
    c();
  ...
  var hh = F((jJ, fh) => {
    ...
    fh.exports = function () {
      return (
        { __proto__: ph }.foo === ph.foo && !({ __proto__: null } instanceof FT)
      );
    };
  });
  var yh = F((HJ, gh) => {
  ...
  var pt = F((eQ, Sh) => {
    ...
    var vh,
      ...
      jr = zn(),
      Gn = Ah(),
      $T = jr.call(Function.call, Array.prototype.concat),
      HT = jr.call(Function.apply, Array.prototype.splice),
      Ch = jr.call(Function.call, String.prototype.replace),
      Wn = jr.call(Function.call, String.prototype.slice),
      UT = jr.call(Function.call, RegExp.prototype.exec),
      zT =
        /[^%.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|%$))/g,
      GT = /\\(\\)?/g,
      WT = function (t) {
  ...
  var _h = F((pQ, Th) => {
    ...
    var XT = di()(),
      ...
      Mr = XT && fi("%Object.defineProperty%", !0);
    if (Mr)
      try {
        Mr({}, "a", { value: 1 });
      } catch {
  ...
  var Nh = F((gQ, kh) => {
    ...
    kh.exports = function (t, r) {
      ...
      return (
        (a || o || !n) &&
          (QT ? Oh(t, "length", r, !0, !0) : Oh(t, "length", r)),
        t
      );
    };
  });
  var $h = F((AQ, Kn) => {
    ...
    var hi = zn(),
      ...
      e8 = Nh(),
      t8 = er("%TypeError%"),
      jh = er("%Function.prototype.apply%"),
      Mh = er("%Function.prototype.call%"),
      qh = er("%Reflect.apply%", !0) || hi.call(Mh, jh),
    ...
    Kn.exports = function (t) {
      ...
      var r = qh(hi, Mh, arguments);
      return e8(r, 1 + r8(0, t.length - (arguments.length - 1)), !0);
    };
    var Lh = function () {
      return qh(hi, jh, arguments);
    };
    qr ? qr(Kn.exports, "apply", { value: Lh }) : (Kn.exports.apply = Lh);
  });
  var Gh = F((xQ, zh) => {
    "use strict";
    l();
  ...
  var pm = F((PQ, dm) => {
    ...
    dm.exports = function e(t, r, n, a) {
      ...
      function m(Y, R, _) {
        if ((R && ((a = p8.call(a)), a.push(R)), _)) {
          var q = { depth: o.depth };
          return (
            ft(o, "quoteStyle") && (q.quoteStyle = o.quoteStyle),
            e(Y, q, n + 1, a)
          );
        }
        return e(Y, o, n + 1, a);
      ...
      if (w8(t)) {
        for (
          ...
          x += " " + S[B].name + "=" + um(f8(S[B].value), "double", o);
        return (
          (x += ">"),
      ...
      if (m8(t)) {
        ...
        return !("cause" in Error.prototype) &&
          ...
          ? "{ [" +
              String(t) +
              "] " +
              Ye.call(Jh.call("[cause]: " + m(t.cause), j), ", ") +
              " }"
          : j.length === 0
          ? "[" + String(t) + "]"
          : "{ [" + String(t) + "] " + Ye.call(j, ", ") + " }";
      ...
      if (typeof t == "object" && i) {
        if (rm && typeof t[rm] == "function" && vi)
          return vi(t, { depth: y - n });
    ...
    function h8(e) {
      return (
        mt(e) === "[object Date]" && (!we || !(typeof e == "object" && we in e))
      );
    }
    function nm(e) {
      return (
    ...
    function B8(e) {
      ...
      return r
        ? "\\" + r
        : "\\x" + (t < 16 ? "0" : "") + d8.call(t.toString(16));
    }
    function $r(e) {
      return "Object(" + e + ")";
    }
    ...
    fm.exports = function () {
      var t,
        ...
        a = {
          assert: function (o) {
            if (!a.has(o))
              throw new R8("Side channel does not contain " + O8(o));
          },
          get: function (o) {
        ...
        if (t) {
          ...
          for (
            ...
            if (
              ((E += 1),
              !n.plainObjects &&
                Pi.call(Object.prototype, s[1].slice(1, -1)) &&
                !n.allowPrototypes)
            )
              return;
            y.push(s[1]);
...
\u2028\u2029])`;
  ...
  var sr,
    ...
    Mg = Ze(() => {
          ...
          var t = e.onMove,
            ...
            p = ot(
              function () {
                var g = function (x) {
                    xg(x),
                      (Xr(x) ? x.touches.length > 0 : x.buttons > 0) &&
                      a.current
                ...
                return [
                  function (x) {
                    ...
                    if (
                      ...
                      B.focus(), o(Cg(B, S, u.current)), b(!0);
                    }
                  },
                  function (x) {
          ...
          return h.createElement(
            ...
            h.createElement(
              Yi,
              {
                ...
                onKey: function (a) {
                  r({
                    s: sr(t.s + 100 * a.left, 0, 100),
                    v: sr(t.v - 100 * a.top, 0, 100),
                  });
                },
                "aria-label": "Color",
                "aria-valuetext":
      ...
      (H4 = typeof window < "u" ? Fu : he),
        (U4 = function () {
          return (
            $4 || (typeof __webpack_nonce__ < "u" ? __webpack_nonce__ : void 0)
          );
        }),
        (Sg = new Map()),
        (Ig = function (e) {
  ...
  var Me,
    ...
    my = Ze(() => {
      ...
      Ot();
      Mg();
      (Me = fe(Vg(), 1)), (dy = fe(sy(), 1));
      Va();
      hr();
      (wR = M.div({ position: "relative", maxWidth: 250 })),
        (BR = M(rn)({ position: "absolute", zIndex: 1, top: 4, left: 4 })),
        (TR = M.div({
          width: 200,
          margin: 5,
                      ...
                      A.map((S, B) =>
                        h.createElement(
                          rn,
                          {
                            key: `${S.value}-${B}`,
                            hasChrome: !1,
                            tooltip: h.createElement(_R, {
                              note: S.keyword || S.value,
                            }),
                          },
                          h.createElement(ly, {
                            value: S[m],
                            active: E && fa(S[m]) === fa(E[m]),
                            onClick: () => y(S.value),
                          }),
                        ),
                      ),
  ...
  function x1(e, t) {
    ...
    var r = it(t);
    return ut(
      Fe({}, r, { saturation: Nt(0, 1, r.saturation - parseFloat(e)) }),
    );
  }
  var CN = Le(x1);
  function S1(e, t) {
      ...
      if ((t && typeof t == "object") || typeof t == "function")
        for (let a of OS(t))
          !PS.call(e, a) &&
            ...
            rp(e, a, {
              get: () => t[a],
              enumerable: !(n = _S(t, a)) || n.enumerable,
            });
      return e;
    },
    NS = (e, t, r) => (
      ...
      kS(
        t || !e || !e.__esModule
          ? rp(r, "default", { value: e, enumerable: !0 })
          : r,
        e,
      )
    ),
  ...
  function $F(e, t = {}) {
    ...
    function n(g, A, ...b) {
      ...
      return r(
        ...
        xt({}, A, x, { className: qF(A?.className, x.className) || void 0 }),
        ...b,
      );
    }
    function a(g) {
...
`,
              ...
              let I = (function (N) {
                ...
                k = (b[w] = (function (N, H) {
                  return N === "style"
                    ...
                    : N === "href"
                    ? Wt(H)
                    : (H.match(rF) && (H = H.slice(1, H.length - 1)),
                      H === "true" || (H !== "false" && H));
                })(I, j));
              typeof k == "string" &&
                (Wo.test(k) || Vo.test(k)) &&
    ...
    let i = [],
      ...
      s = {
        ...
        htmlComment: { t: Or(yp), i: re.HIGH, l: () => ({}), h: zo },
        image: {
          t: dt(RF),
          i: re.HIGH,
        ...
        link: {
          t: ct(OF),
          i: re.LOW,
          l: (g, A, b) => ({ v: jF(A, g[1], b), B: cp(g[2]), F: g[3] }),
          h: (g, A, b) =>
              ...
              n(
                ...
                n(
                  ...
                  g.L.map(function (x, S) {
                    return n("th", { key: S, style: lp(g, S) }, A(x, b));
                  }),
                ),
              ),
              n(
      ...
      ((s.htmlBlock = {
        ...
        l(g, A, b) {
          let [, x] = g[3].match(FF),
            S = new RegExp(`^${x}`, "gm"),
            B = g[3].replace(S, ""),
            I = ((j = B), PF.some((H) => H.test(j)) ? MF : Bn);
          var j;
...
`,
        ...
        function g(A, b = {}) {
          if (Array.isArray(A)) {
            ...
            for (let I = 0; I < A.length; I++) {
              ...
              let j = g(A[I], b),
                w = typeof j == "string";
              w && B ? (S[S.length - 1] += j) : j !== null && S.push(j),
                (B = w);
            }
            return (b.k = x), S;
          }
  ...
  var XK = __STORYBOOKCOREEVENTS__,
    {
      ...
      NAVIGATE_URL: n0,
      PLAY_FUNCTION_THREW_EXCEPTION: M3,
      PRELOAD_ENTRIES: q3,
  ...
  var nB = Object.create,
    ...
    Ke = (e, t) =>
      function () {
        return (
          t || (0, e[u0(e)[0]])((t = { exports: {} }).exports, t), t.exports
        );
      },
    uB = (e, t, r, n) => {
      if ((t && typeof t == "object") || typeof t == "function")
    ...
    s0 = (e, t, r) => (
      ...
      uB(
        t || !e || !e.__esModule
          ? i0(r, "default", { value: e, enumerable: !0 })
          : r,
        e,
      )
    );
      ...
      `),
          ...
          : (r.add(e),
            Array.isArray(e)
              ...
              : {
                  name: "object",
                  value: (0, kr.default)(e, (a) => ai(a, t, new Set(r))),
                })
        : { name: "object", value: {} };
    },
    CT = (e) => {
      let { id: t, argTypes: r = {}, initialArgs: n = {} } = e,
        a = (0, kr.default)(n, (i, u) => ({
          name: u,
          type: ai(i, `${t}.${u}`, new Set()),
        })),
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
  ...
  var H_ = Object.create,
    ...
    je = (e, t) =>
      function () {
        return (
          t || (0, e[zm(e)[0]])((t = { exports: {} }).exports, t), t.exports
        );
      },
    W_ = (e, t, r, n) => {
      if ((t && typeof t == "object") || typeof t == "function")
    ...
    K_ = ["detail"];
  function Gm(e) {
    let t = V_.filter((r) => e[r] !== void 0).reduce(
      (r, n) => ({ ...r, [n]: e[n] }),
      {},
    );
    return (
...
` &&
  ...
  var w4 = function (t) {
      ...
      return function (u, s) {
        try {
          ...
          if (typeof s == "string")
            return S4.test(s) ? (t.allowDate ? `_date_${s}` : void 0) : s;
          if ((0, nO.default)(s))
  ...
  var l9 = M(JR)({
    ...
    c9 = M.div({ overflow: "hidden", position: "relative" }),
    ou = ({
      isLoading: e,
      isColumn: t,
      columns: r,
      ...
      let [E, m] = ne(i),
        ...
        N = ge(async (V) => {
          let { createCopyToClipboardFunction: U } =
            await Promise.resolve().then(() => (hr(), Ru));
          U();
        }, []),
        H = (V) => {
    ...
    m9 = M.span(Rt, ({ theme: e, simple: t = !1 }) => ({
      flex: "0 0 auto",
      fontFamily: e.typography.fonts.mono,
      fontSize: e.typography.size.s1,
    ...
    E9 = M(Oe)({ height: 10, width: 10, minWidth: 10, marginLeft: 4 }),
    A9 = () => h.createElement("span", null, "-"),
    jy = ({ text: e, simple: t }) => h.createElement(m9, { simple: t }, e),
    ...
    by = (e, t = !0) => {
      ...
      return (
        t || (r = e.slice(0, iu)),
        r.map((n) => h.createElement(jy, { key: n, text: n === "" ? '""' : n }))
      );
    },
    C9 = ({ value: e, initialExpandedArgs: t }) => {
      ...
      if (n == null) {
        if (/[(){}[\]<>]/.test(s)) return h.createElement(jy, { text: s });
        let p = D9(s),
          y = p.length;
        return y > iu
          ? h.createElement(
  ...
  var { window: lP } = ue,
    ...
    Cy = M(Oe)(({ theme: e, icon: t, disabled: r }) => ({
      display: "inline-block",
    ...
    xy = M.input(({ theme: e, placeholder: t }) => ({
      outline: 0,
      margin: t ? 1 : "1px 0",
      padding: "3px 4px",
      color: e.color.defaultText,
        ...
        i
          ...
          : h.createElement(Yy, {
              ...
              inputElement: (x, S, B, I) =>
                I
                  ? h.createElement(xy, { onFocus: mP, onBlur: hP })
                  : h.createElement(xy, null),
              fallback: b,
            }),
      );
    },
    yP = M.input(({ theme: e, min: t, max: r, value: n }) => ({
      "&": {
        width: "100%",
    ...
    bP = M(Xy)(({ numberOFDecimalsPlaces: e, max: t }) => ({
      width: `${e + t.toString().length * 2 + 3}ch`,
      textAlign: "right",
      flexShrink: 0,
    })),
    EP = M.div({ display: "flex", alignItems: "center", width: "100%" });
  function AP(e) {
  ...
  var wP = ({ onChange: e, name: t, accept: r = "image/*", value: n }) => {
    ...
    NP = M.div(({ theme: e, hasDescription: t }) => ({
      color:
        e.base === "light"
          ? de(0.1, e.color.defaultText)
          : de(0.2, e.color.defaultText),
      ...
      return h.createElement(
        ...
        o
          ...
          : h.createElement(
              "td",
              null,
              h.createElement(tu, { value: m, initialExpandedArgs: u }),
            ),
        a
          ? h.createElement(
              "td",
              null,
              h.createElement(OP, { ...e, isHovered: t }),
            )
          : null,
      );
    },
      ...
      return h.createElement(
        ...
        h.createElement(
          ...
          h.createElement(
            ...
            h.createElement(MP, null, h.createElement(jP, { icon: y }), t),
          ),
          h.createElement(
            HP,
            { colSpan: a - 1 },
    ...
    GP = M.div(({ inAddonPanel: e, theme: t }) => ({
      height: e ? "100%" : "auto",
      display: "flex",
    ...
    QP = M.table(({ theme: e, compact: t, inAddonPanel: r }) => ({
      "&&": {
        borderSpacing: 0,
        color: e.color.defaultText,
        "td, th": {
    ...
    eI = M.span({ display: "flex", justifyContent: "space-between" }),
    tI = {
    ...
    wne = M.div(Pt, ({ theme: e }) => ({
      ...ba(e),
      margin: "25px 0 40px",
      padding: "30px 20px",
    }));
  var Bne = M.div(({ theme: e }) => ({
      fontWeight: e.typography.weight.bold,
      color: e.color.defaultText,
    })),
    Tne = M.div(({ theme: e }) => ({
    ...
    _ne = M.div({ flex: "0 0 30%", lineHeight: "20px", marginTop: 5 }),
    One = M.div(({ theme: e }) => ({
      flex: 1,
      textAlign: "center",
      fontFamily: e.typography.fonts.mono,
    ...
    Rne = M.div({ display: "flex", flexDirection: "row" }),
    Pne = M.div(({ background: e }) => ({
      position: "relative",
      flex: 1,
      "&::before": {
        position: "absolute",
    ...
    Nne = M.div({ flex: 1, display: "flex", flexDirection: "row" }),
    Lne = M.div({ display: "flex", alignItems: "flex-start" }),
    jne = M.div({ flex: "0 0 30%" }),
    Mne = M.div({ flex: 1 }),
    qne = M.div(({ theme: e }) => ({
      display: "flex",
      flexDirection: "row",
  ...
  var uI = (e, t) => {
    ...
    cI = (e) => {
      ...
      try {
        ...
        if (
          (B || ((m = null), (g = null), (S = {})),
          n && (!B || o) && (S = lu(S, { [x]: n }, y.parameters, i, u)),
          a)
        ) {
          if (Array.isArray(a))
            throw new Error(
          ...
          S = lu(S, a, y.parameters, i, u);
        }
        return h.createElement(Jy, { tabs: S, sort: s });
      } catch (p) {
...
`));
  ...
  var cu = Ha.a,
            ...
            cu,
            {
              ...
              onClick: (i) => {
                i.button === 0 &&
                  ...
                  !i.shiftKey &&
                  (i.preventDefault(),
                  Eu(o, i.currentTarget.getAttribute("href")));
              },
              target: r,
              ...a,
            },
    ...
    TI = a2.reduce(
      (e, t) => ({ ...e, [t]: (r) => h.createElement(Au, { as: t, ...r }) }),
      {},
    ),
    _I = (e) => {
    ...
    LI = (e) => {
      ...
      return (
        ...
        r &&
          ye(`Manually specifying description type is deprecated. See ${ya}`),
        n &&
          ye(
  ...
  var jI = ({ children: e, disableAnchor: t }) => {
      ...
      return h.createElement(
        ...
        t &&
          h.createElement(
            h.Fragment,
            null,
            h.createElement(jI, null, o.name),
  ...
  var qI = ({ children: e, disableAnchor: t, ...r }) => {
